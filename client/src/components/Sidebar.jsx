    ...
    <Box component='nav'>
      {isSidebarOpen && (
        <Drawer
          ...
          sx={{
            width: drawerWidth,
            '& .MuiDrawer-paper': { color: theme.palette.secondary[200], backgroundColor: theme.palette.background.alt, borderWidth: isNonMobile ? 0 : '2px', width: drawerWidth },
          }}>
          <Box width='100%'>
              ...
              {navItems.map(({ text, icon }) => {
                ...
                return (
                  <ListItem key={text} disablePadding>
                    <NavLink to={`/${lcText}`} style={{ textDecoration: 'none', width: '100%' }}>
                      {({ isActive }) => (
                        <ListItemButton
                          sx={{
                            ...
                            '&:hover': { backgroundColor: isActive && theme.palette.secondary[400] },
                          }}>
                          <ListItemIcon
                            sx={{
                              ml: '2rem',
